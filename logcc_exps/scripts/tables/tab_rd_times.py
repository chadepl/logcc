...
if __name__ == "__main__":
    ...
    #print()
    #print(df_pivoted_stds)


    # ind_df = df[df["dataset"] == ["cvp_meteo", "hptc_brainstem", "hptc_right_parotid"][0]]
    # ind_df = ind_df[ind_df["rho"] == 0.5]
    # ind_df = ind_df[ind_df["method"] == "pfaffelmoser2012"]
    # ind_df = ind_df[ind_df["accelerate_flag"] == False]
    # print(ind_df)
